package com.soa.circuit.model.source;
...
public class TestVoltageSrcAC{
	...
	private static void testDiode5(){
		ModelReader reader = new ModelReader();
		try{
			//CircuitModel model = reader.readModel("sources/ac/sine.cir");
			CircuitModel model = reader.readModel("diode/diode3.cir");
			...
			double[] ny4 = results.viewColumn(3).toArray();
			...
			JFrame frame = new JFrame("half wave rectifier");
